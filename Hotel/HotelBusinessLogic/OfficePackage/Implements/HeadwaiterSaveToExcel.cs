...
{
    public class HeadwaiterSaveToExcel : HeadwaiterAbstractSaveToExcel
    {
        ...
        protected override void CreateExcel(HeadwaiterExcelInfo info)
        {
        ...
        protected override void SaveExcel(HeadwaiterExcelInfo info)
        {
