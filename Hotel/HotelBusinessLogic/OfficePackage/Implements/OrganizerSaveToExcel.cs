...
{
    public class OrganizerSaveToExcel : OrganizerAbstractSaveToExcel
    {
        ...
        protected override void CreateExcel(OrganizerExcelInfo info)
        {
        ...
        protected override void SaveExcel(OrganizerExcelInfo info)
        {
